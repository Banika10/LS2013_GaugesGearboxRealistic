...
function fwGaugesGearboxRealistic_Mod:init(modName)
	...
	--SpecializationUtil.registerSpecialization("manualIgnition", "manualIgnition", Utils.getFilename('manualIgnition.lua', __DIR_GAME_MOD__..modName..'/app/specialization/'));		
